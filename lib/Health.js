...
class HealthMonitor extends NGN.EventEmitter {
  constructor (config) {
    ...
    Object.defineProperties(this, {
       ...
       */
      heartbeatWaitInterval: NGN.private(config.heartbeat || 15 * 1000), // 15 seconds
       ...
       */
      statusWaitInterval: NGN.private(config.status || 5 * 60 * 1000), // Every 5 minutes
       ...
       */
      infoWaitInterval: NGN.private(config.info || 5 * 60 * 1000), // Every 5 minutes (only if info changes)
