			...
			host: {
				...
				rule: {
					post: function(req,res){
						...
						vh.addRewriteRule(req.form.method.toUpperCase(),pat,sub,__NGN.coalesce(req.form.last,false),req.form.position||null);
