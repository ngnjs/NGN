...
// Create Models
global.__MODEL = __NGN.model || {};
Object.defineProperty(global,'MODEL',{
	enumerable:	true,
	get:		function(){ return global.__MODEL; }
});
Object.defineProperty(global,'model',{
	enumerable:	true,
	get:		function(){ return global.__MODEL; }
...
// Remove redundant namespace for MODEL
if (global.__NGN.model !== undefined)
	delete global.__NGN.model;
				...
				case 'extensions':
					if (Array.isArray(_cfg[item])) {
						for (var i=0;i<_cfg[item].length;i++){
							if (!fs.existsSync(fs_cfg[item][i]))
...
console.info(('Running NGN v'+__NGN.version).grey);