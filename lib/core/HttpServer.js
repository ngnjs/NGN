...
var Class = Base.extend({
	...
	constructor: function(config){
		...
		Object.defineProperties(this,{
			 ...
			 * 
			 * **IMPORTANT**
			 * If an environment variable, i.e. `process.env.PORT` is provided, it will
			 * overwrite this configuration value automatically.
			 */
			port: {
				value:		process.env.PORT || config.port || (this.ssl == null ? 80 : 443),
				enumerable:	true,
				writable:	true
			},
			...
			/**
			 * @cfg {Function/Array/NGN.web.Processor} [processor=[]]
