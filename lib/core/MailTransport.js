...
var Class = Base.extend({
	...
	constructor: function(config){
		...
		Object.defineProperties(this,{
			 ...
			 */
			secureConnection: {
				value:		this.port !== 587 ? __NGN.coalesce(config.secureConnection,false) : false,
				enumerable:	true,
				writable:	true
			},
			 ...
			 */
			ignoreTLS: {
				value:		__NGN.coalesce(config.ignoreTLS,false),
				enumerable:	true,
				writable:	true
			},
			 ...
			 */
			debug: {
				value:		__NGN.coalesce(config.debug,false),
				enumerable:	true,
				writable:	true
			},
