...
var Class = Base.extend({
        ...
        send:{
          ...
          value: function(eventName,meta){
            if (process.mechanic.client.connected){
              console.log('Supposed to send ',eventName)
 ...
 /**
  ...
  onMechanicAuthenticationRequest: function(){
    ...
    console.log('need to send data to server'.magenta.bold,this.connected,process.mechanic.client.connected);
    process.mechanic.send('register',this.getRegistrationData());
    console.log(process.mechanic);
  }
