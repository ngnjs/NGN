...
var Class = Base.extend({
	...
	constructor: function(config){
		...
		Object.defineProperties(this,{
			 ...
			 */
			exitOnError: {
				value:		__NGN.coalesce(config.exitOnError,false),
				enumerable:	true,
				writable:	true
			},
			 ...
			 */
			disabled: {
				value:		__NGN.coalesce(config.disabled,false),
				enumerable:	true,
				writable:	true
			}
	...
	onDisable: function(){
		if (!this.disabled) {
			this.disabled = true;
			this.fireEvent('logDisabled',this);
		}
	},
	...
	onEnable: function(){
		if(this.disabled){
			this.disabled = false;
			this.fireEvent('logEnabled',this);
		}
	},
	...
	onInfo: function(record){
		this.fireEvent('logInfo',record||null);
	},
	...
	onWarn: function(record){
		this.fireEvent('logWarn',record||null);
	},
	...
	onDebug: function(record){
		this.fireEvent('logDebug',record||null);
	},
