var Base = require('../core/Server'), //TODO: Convert this to HttpTransport?
    path = require('path'),
    send = require('send'),
    http = require('http'),
    url = require('url');
...
/**
 * @class NGN.http.StaticWebServer
 ...
 * NGN.http.Server is a more appropriate fit (which can also serve static files). 
 * 
...
var Class = Base.extend({
	...
	constructor: function(config){
		...
		Object.defineProperties(this,{
			...
			/**
			 * @cfg {String} root (required)
			 * Path to root directory where static assets are stored.
			 */
			root: {
				value:		path.normalize(config.root),
				enumerable:	true,
				writable:	true
			},
