...
var Class = Base.extend({
	...
	constructor: function(config){
		...
		switch (this.mailType.toUpperCase()){
			case 'SMTP':
		...
		this._transport = nodemailer.createTransport(this.mailType,options);
	 ...
	 */
	close: function(){
		if (this.running && this.mailType == 'SMTP') {
