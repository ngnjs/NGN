...
this.fireError('test');		
		Object.defineProperties(this,{
				...
				set:		function(value){
					...
					console.log('1');
									...
									if (this.renderer == null && __NGN.path.extname(value) !== null)
										this.renderer = __NGN.path.extname(value);
			...
			renderer: {
				...
				set:		function(value){
								if(this.engines.indexOf(value) >= 0)
	 ...
	 */
	onUnrecorgnizedRenderer: function(){
		this.emit('unrecognizedrenderer');
		console.log('WARNING:'.yellow+' '+this.renderer.yellow.bold+' is not a recognized template renderer.');
	},
	...
	onMissingFile: function(file){
		...
		console.log(this)
		this.fireError('missing',file||this.tpl);
	},
