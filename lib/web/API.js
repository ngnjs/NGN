...
var Class = Base.extend({
	...
	generateRoutes: function() {
		...
		this._generateRoutes(function(rootExists){
			...
			// Catch All Route
			var all = /(.*)/;
			me._server.get(all,function(req,res){
				me.on404(res);
				res.send(404);
			});
			me._server.post(all,function(req,res){
				me.on404(res);
				res.send(404);
			});
			me._server.put(all,function(req,res){
				me.on404(res);
				res.send(404);
			});
			me._server.del(all,function(req,res){
				me.on404(res);
				res.send(404);
			});
			me._server.head(all,function(req,res){
				me.on404(res);
				res.send(404);
			});
		});
