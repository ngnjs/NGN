...
test('NGN.slice & NGN.splice', function (t) {
  const tempFn = function () {
    const x = NGN.slice(arguments)
    const y = NGN.splice(arguments)
...
test('NGN.getObjectMissingPropertyNames', function (t) {
  ...
  const missing = NGN.getObjectMissingPropertyNames(obj, 'a', 'b', 'c', 'd', 'e', 'f')
...
test('NGN.getObjectExtraneousPropertyNames', function (t) {
  ...
  const extra = NGN.getObjectExtraneousPropertyNames(obj, 'a', 'b', 'c', 'e')
