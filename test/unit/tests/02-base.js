...
test('NGN.stack', function (t) {
  ...
  t.ok(
    ...
    stack[0].hasOwnProperty('functionname') &&
    stack[0].hasOwnProperty('native') &&
    stack[0].hasOwnProperty('eval') &&
    stack[0].hasOwnProperty('type') &&
    stack[0].hasOwnProperty('async') &&
    stack[0].hasOwnProperty('raw') &&
    stack[0].hasOwnProperty('object'),
